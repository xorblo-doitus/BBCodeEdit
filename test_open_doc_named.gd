...
const CONTANT_INT = 5
## [constant BbcodeEdit]
const BbcodeEdit = preload("res://addons/bbcode_edit/doc_comment.editor/bbcode_edit.gd")
...
## aaa[img width=32 height=10 color=red region=0,0,10,10 tootip=hello]res://addons/bbcode_edit/doc_comment.editor/bbcode_completion_icon.svg[/img]bbb
func doc_test()-> void:
	pass
